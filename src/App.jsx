...
function App() {
  ...
  //total price & total payment start
  const totalPrice = state.reduce((acc, obj) => {
    return acc + +obj.price * obj.count;
  }, 0);

  const totalPayment = state.reduce((acc, obj) => {
    return acc + +Math.round(obj.price * obj.count * (1 - obj.discount * 0.01));
  }, 0);
  //total price & total payment end
